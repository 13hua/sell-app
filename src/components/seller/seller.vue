        ...
        <div class="seller-content">
            ...
            <div class="bulletin">
                ...
                <ul v-if="seller.supports" class="supports">
                  <li class="supports-item border-1px" v-for="item in seller.supports" :key="item.id">
                    <!-- <span class="icon" :class="classMap[item.type]"></span> -->
                     <v-icon :item="item.type" iconIndex="3"></v-icon>
  ...
  methods: {
    ...
    _initPicScroll() {
      if (this.seller.pics) {
        let picWidth = 120;
        let margin = 6;
        let width = (picWidth + margin) * this.seller.pics.length - margin; // .pic-list ul 的宽度
